...
class WorkFiles(object):
    ...
    def _do_open_workfile(self, file):
        ...
        return self._do_copy_and_open(src_path, work_path, file.version, not file.editable, new_ctx)
    ...
    def _do_open_publish_read_only(self, file):
        ...
        return self._do_copy_and_open(None, file.publish_path, file.version, True, new_ctx)

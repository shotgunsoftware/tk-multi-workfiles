...
class WorkFiles(object):
    ...
    def change_work_area(self, do_change_work_area=False):
        """
        ...
        if res == QtGui.QDialog.Accepted:
            if do_change_work_area:
                self._do_change_work_area(widget.context)
            else:
    ...
    def _do_change_work_area(self, context):
        """
        ...
        message.setWindowTitle("Change Work Area?")

...
################################################################################
## Form generated from reading UI file 'open_file_form.ui'
##
...
class Ui_OpenFileForm(object):
    def setupUi(self, OpenFileForm):
        if not OpenFileForm.objectName():
            OpenFileForm.setObjectName(u"OpenFileForm")
        OpenFileForm.resize(514, 666)
        self.verticalLayout_3 = QVBoxLayout(OpenFileForm)
        ...
        self.name_label = QLabel(OpenFileForm)
        self.name_label.setObjectName(u"name_label")

        self.verticalLayout_6.addWidget(self.name_label)

        self.name_line = QFrame(OpenFileForm)
...
"}")
        ...
        self.or_label_a = QLabel(OpenFileForm)
        ...
        self.work_file_frame = QFrame(OpenFileForm)
...
"}")
        ...
        self.or_label_b = QLabel(OpenFileForm)
        ...
        self.publish_ro_frame = QFrame(OpenFileForm)
...
"}")
        ...
        self.break_line = QFrame(OpenFileForm)
        ...
        self.cancel_btn = QPushButton(OpenFileForm)
        ...
        QMetaObject.connectSlotsByName(OpenFileForm)
    # setupUi

    def retranslateUi(self, OpenFileForm):
        OpenFileForm.setWindowTitle(QCoreApplication.translate("OpenFileForm", u"Form", None))
        self.name_label.setText(QCoreApplication.translate("OpenFileForm", u"<big><b>name</b></big>", None))
        self.title_label.setText(QCoreApplication.translate("OpenFileForm", u"<big>There is a more recent, published version of this file available!</big>", None))
#if QT_CONFIG(tooltip)
        self.publish_frame.setToolTip(QCoreApplication.translate("OpenFileForm", u"Click to open the newer Published File", None))
#endif // QT_CONFIG(tooltip)
        self.publish_title_label.setText(QCoreApplication.translate("OpenFileForm", u"<big>Would you like to continue your work from the latest Publish?</big>", None))
        self.publish_details.setText(QCoreApplication.translate("OpenFileForm", u"<html><head/><body><p>Version v000<br/>Published on...<br/>Published by...<br/>Description:<br/><span style=\" font-style:italic;\">No description was entered for this publish</span></p></body></html>", None))
        self.publish_thumbnail.setText("")
        self.publish_note.setText(QCoreApplication.translate("OpenFileForm", u"<html><head/><body><p><small>(Note: The published file will be copied to your work area as version v000 and then opened)</small></p></body></html>", None))
        self.or_label_a.setText(QCoreApplication.translate("OpenFileForm", u"<big><b>OR</b></big>", None))
#if QT_CONFIG(tooltip)
        self.work_file_frame.setToolTip(QCoreApplication.translate("OpenFileForm", u"Click to open the older Work File", None))
#endif // QT_CONFIG(tooltip)
        self.work_file_title_label.setText(QCoreApplication.translate("OpenFileForm", u"<big>Would you prefer to open the older Work File instead?</big>", None))
        self.work_file_details.setText(QCoreApplication.translate("OpenFileForm", u"<html><head/><body><p>Version v000<br/>Updated on...<br/>Updated by...</p></body></html>", None))
        self.work_file_thumbnail.setText("")
        self.or_label_b.setText(QCoreApplication.translate("OpenFileForm", u"<big><b>OR</b></big>", None))
#if QT_CONFIG(tooltip)
        self.publish_ro_frame.setToolTip(QCoreApplication.translate("OpenFileForm", u"<html><head/><body><p>Click to open the older Published File read-only</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
        self.publish_ro_title_label.setText(QCoreApplication.translate("OpenFileForm", u"<html><head/><body><p><span style=\" font-size:large;\">You can open the older Publish read-only?</span></p></body></html>", None))
        self.label_9.setText(QCoreApplication.translate("OpenFileForm", u"<html><head/><body><p><span style=\" font-style:italic;\">Note: If you open the Publish read-only, you will have to save the file into your Work Area before you can continue working with it.</span></p></body></html>", None))
        self.cancel_btn.setText(QCoreApplication.translate("OpenFileForm", u"Cancel", None))
    # retranslateUi
